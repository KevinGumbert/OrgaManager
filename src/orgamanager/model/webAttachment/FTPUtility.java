/*
 * Code von 
 * http://www.codejava.net/coding/swing-application-to-upload-files-to-ftp-server-with-progress-bar
 * 
 * The uploadFile() method just initiates a file transfer session with the server (opening an output stream).
   The writeFileBytes() method will be invoked by the UploadTask to transfer a byte array to the server. 
   This helps the UploadTaskdetermines upload progress and update the progress bar appropriately.
 */
...
//org.apache.commons.net Bib muss einhgefuegt werden
